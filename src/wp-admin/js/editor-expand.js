( function( window, $, undefined ) {
	...
	$( function() {
		...
		/**
		 * Binds all necessary functions for editor expand to the editor when the editor is initialized.
		 *
		 * @since 4.0.0
		 *
		...
		/**
		 * Adjusts the toolbars heights and positions based on the scroll position on the page,
