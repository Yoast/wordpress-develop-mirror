...
class AuthorHelper {
	 ...
	 *
	 */
	public static function getTheAuthor( $deprecated = '' ) {
		global $authordata;
	 ...
	 *
	 */
	public static function theAuthor( $deprecated = '', $deprecated_echo = true ) {
		if ( ! empty( $deprecated ) ) {
			_deprecated_argument( __FUNCTION__, '2.1.0' );
		}
	 ...
	 *
	 */
	public static function getTheModifiedAuthor() {
	 ...
	 * @see get_the_author()
	 */
	public static function theModifiedAuthor() {
	 ...
	 *
	 */
	public static function getTheAuthorMeta( $field = '', $user_id = false ) {
	 ...
	 */
	public static function theAuthorMeta( $field = '', $user_id = false ) {
	 ...
	 *
	 */
	public static function getTheAuthorLink() {
	 ...
	 * @since 2.1.0
	 */
	public static function theAuthorLink() {
	 ...
	 *
	 */
	public static function getTheAuthorPosts() {
		$post = get_post();
		if ( ! $post ) {
			return 0;
		}
	 ...
	 * @since 0.71
	 */
	public static function theAuthorPosts() {
	 ...
	 *
	 */
	public static function getTheAuthorPostsLink() {
		global $authordata;
	 ...
	 * @since 1.2.0
	 */
	public static function theAuthorPostsLink( $deprecated = '' ) {
		if ( ! empty( $deprecated ) ) {
			_deprecated_argument( __FUNCTION__, '2.1.0' );
		}
	 ...
	 *
	 */
	public static function getAuthorPostsUrl( $author_id, $author_nicename = '' ) {
		global $wp_rewrite;
	 ...
	 */
	public static function listAuthors( $args = '' ) {
		global $wpdb;
		...
		$query_args           = wp_array_slice_assoc( $args, array(
			'orderby',
			'order',
			'number',
			'exclude',
	 ...
	 *
	 */
	public static function isMultiAuthor() {
		global $wpdb;
	 ...
	 * @access private
	 */
	public static function clearMultiAuthorCache() { //phpcs:ignore WordPress.NamingConventions.ValidFunctionName.FunctionDoubleUnderscore
