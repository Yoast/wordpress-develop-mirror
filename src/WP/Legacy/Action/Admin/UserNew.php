...
class UserNew implements ActionInterface {

	public function perform() {
		global $wpdb, $blog_id, $user_email, $role, $title, $parent_file, $type, $redirect;
				...
				>
					...
					<table class="form-table" role="presentation">
						<tr class="form-field form-required">
							...
							<td><input name="email" type="<?php echo $type; ?>" id="adduser-email"
