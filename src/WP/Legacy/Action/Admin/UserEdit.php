...
class UserEdit implements ActionInterface {

	public function perform() {
		global $wpdb, $current_user, $submenu_file, $parent_file, $errors, $title, $id, $user_id,
		       $user_login, $_wp_admin_css_colors, $wp_http_referer, $action, $wp_roles;
