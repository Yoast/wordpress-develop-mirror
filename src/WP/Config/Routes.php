...
class Routes {
	const ROUTES = [
		...
		'wp-admin/network/user-edit' => UserEdit::class,
		'wp-admin/network/profile'   => UserEdit::class,
		'wp-admin/user/user-edit'    => UserEdit::class,
		'wp-admin/user/profile'      => UserEdit::class,
	];
}
