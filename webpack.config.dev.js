...
admin_files = {
	'src/wp-admin/js/accordion.js': ['./src/js/accordion.js'],
	'src/wp-admin/js/code-editor.js': ['./src/js/code-editor.js'],
	'src/wp-admin/js/color-picker.js': ['./src/js/color-picker.js'],
	'src/wp-admin/js/comment.js': ['./src/js/comment.js'],
	'src/wp-admin/js/common.js': ['./src/js/common.js'],
	'src/wp-admin/js/custom-background.js': ['./src/js/custom-background.js'],
	'src/wp-admin/js/custom-header.js': ['./src/js/custom-header.js'],
	'src/wp-admin/js/customize-controls.js': ['./src/js/customize-controls.js'],
	'src/wp-admin/js/customize-nav-menus.js': ['./src/js/customize-nav-menus.js'],
	'src/wp-admin/js/customize-widgets.js': ['./src/js/customize-widgets.js'],
	'src/wp-admin/js/dashboard.js': ['./src/js/dashboard.js'],
	'src/wp-admin/js/edit-comments.js': ['./src/js/edit-comments.js'],
	'src/wp-admin/js/editor-expand.js': ['./src/js/editor-expand.js'],
	'src/wp-admin/js/editor.js': ['./src/js/editor.js'],
	'src/wp-admin/js/gallery.js': ['./src/js/gallery.js'],
	'src/wp-admin/js/image-edit.js': ['./src/js/image-edit.js'],
	'src/wp-admin/js/inline-edit-post.js': ['./src/js/inline-edit-post.js'],
	'src/wp-admin/js/inline-edit-tax.js': ['./src/js/inline-edit-tax.js'],
	'src/wp-admin/js/language-chooser.js': ['./src/js/language-chooser.js'],
	'src/wp-admin/js/link.js': ['./src/js/link.js'],
	'src/wp-admin/js/media-gallery.js': ['./src/js/media-gallery.js'],
	'src/wp-admin/js/media-upload.js': ['./src/js/media-upload.js'],
	'src/wp-admin/js/media.js': ['./src/js/media.js'],
	'src/wp-admin/js/nav-menu.js': ['./src/js/nav-menu.js'],
	'src/wp-admin/js/password-strength-meter.js': ['./src/js/password-strength-meter.js'],
	'src/wp-admin/js/plugin-install.js': ['./src/js/plugin-install.js'],
	'src/wp-admin/js/post.js': ['./src/js/post.js'],
	'src/wp-admin/js/postbox.js': ['./src/js/postbox.js'],
	'src/wp-admin/js/revisions.js': ['./src/js/revisions.js'],
	'src/wp-admin/js/set-post-thumbnail.js': ['./src/js/set-post-thumbnail.js'],
	'src/wp-admin/js/svg-painter.js': ['./src/js/svg-painter.js'],
	'src/wp-admin/js/tags-box.js': ['./src/js/tags-box.js'],
	'src/wp-admin/js/tags-suggest.js': ['./src/js/tags-suggest.js'],
	'src/wp-admin/js/tags.js': ['./src/js/tags.js'],
	'src/wp-admin/js/theme-plugin-editor.js': ['./src/js/theme-plugin-editor.js'],
	'src/wp-admin/js/theme.js': ['./src/js/theme.js'],
	'src/wp-admin/js/updates.js': ['./src/js/updates.js'],
	'src/wp-admin/js/user-profile.js': ['./src/js/user-profile.js'],
	'src/wp-admin/js/user-suggest.js': ['./src/js/user-suggest.js'],
	'src/wp-admin/js/widgets/custom-html-widgets.js': ['./src/js/widgets/custom-html-widgets.js'],
	'src/wp-admin/js/widgets/media-audio-widget.js': ['./src/js/widgets/media-audio-widget.js'],
	'src/wp-admin/js/widgets/media-gallery-widget.js': ['./src/js/widgets/media-gallery-widget.js'],
	'src/wp-admin/js/widgets/media-image-widget.js': ['./src/js/widgets/media-image-widget.js'],
	'src/wp-admin/js/widgets/media-video-widget.js': ['./src/js/widgets/media-video-widget.js'],
	'src/wp-admin/js/widgets/media-widgets.js': ['./src/js/widgets/media-widgets.js'],
	'src/wp-admin/js/widgets/text-widgets.js': ['./src/js/widgets/text-widgets.js'],
	'src/wp-admin/js/widgets.js': ['./src/js/widgets.js'],
	'src/wp-admin/js/word-count.js': ['./src/js/word-count.js'],
	'src/wp-admin/js/wp-fullscreen-stub.js': ['./src/js/wp-fullscreen-stub.js'],
	'src/wp-admin/js/xfn.js': ['./src/js/xfn.js'],
}

include_files = {
	'src/wp-includes/js/admin-bar.js': ['./src/js/admin-bar.js'],
	'src/wp-includes/js/api-request.js': ['./src/js/api-request.js'],
	'src/wp-includes/js/autosave.js': ['./src/js/autosave.js'],
	'src/wp-includes/js/comment-reply.js': ['./src/js/comment-reply.js'],
	'src/wp-includes/js/customize-base.js': ['./src/js/customize-base.js'],
	'src/wp-includes/js/customize-loader.js': ['./src/js/customize-loader.js'],
	'src/wp-includes/js/customize-models.js': ['./src/js/customize-models.js'],
	'src/wp-includes/js/customize-preview-nav-menus.js': ['./src/js/customize-preview-nav-menus.js'],
	'src/wp-includes/js/customize-preview-widgets.js': ['./src/js/customize-preview-widgets.js'],
	'src/wp-includes/js/customize-preview.js': ['./src/js/customize-preview.js'],
	'src/wp-includes/js/customize-selective-refresh.js': ['./src/js/customize-selective-refresh.js'],
	'src/wp-includes/js/customize-views.js': ['./src/js/customize-views.js'],
	'src/wp-includes/js/heartbeat.js': ['./src/js/heartbeat.js'],
	'src/wp-includes/js/mce-view.js': ['./src/js/mce-view.js'],
	'src/wp-includes/js/media-audiovideo.js': ['./src/js/media/audiovideo.manifest.js'],
	'src/wp-includes/js/media-editor.js': ['./src/js/media-editor.js'],
	'src/wp-includes/js/media-grid.js': ['./src/js/media/grid.manifest.js'],
	'src/wp-includes/js/media-models.js': ['./src/js/media/models.manifest.js'],
	'src/wp-includes/js/media-views.js': ['./src/js/media/views.manifest.js'],
	'src/wp-includes/js/quicktags.js': ['./src/js/quicktags.js'],
	'src/wp-includes/js/shortcode.js': ['./src/js/shortcode.js'],
	'src/wp-includes/js/utils.js': ['./src/js/utils.js'],
	'src/wp-includes/js/wp-a11y.js': ['./src/js/wp-a11y.js'],
	'src/wp-includes/js/wp-ajax-response.js': ['./src/js/wp-ajax-response.js'],
	'src/wp-includes/js/wp-api.js': ['./src/js/wp-api.js'],
	'src/wp-includes/js/wp-auth-check.js': ['./src/js/wp-auth-check.js'],
	'src/wp-includes/js/wp-backbone.js': ['./src/js/wp-backbone.js'],
	'src/wp-includes/js/wp-custom-header.js': ['./src/js/wp-custom-header.js'],
	'src/wp-includes/js/wp-embed-template.js': ['./src/js/wp-embed-template.js'],
	'src/wp-includes/js/wp-embed.js': ['./src/js/wp-embed.js'],
	'src/wp-includes/js/wp-emoji-loader.js': ['./src/js/wp-emoji-loader.js'],
	'src/wp-includes/js/wp-emoji.js': ['./src/js/wp-emoji.js'],
	'src/wp-includes/js/wp-list-revisions.js': ['./src/js/wp-list-revisions.js'],
	'src/wp-includes/js/wp-lists.js': ['./src/js/wp-lists.js'],
	'src/wp-includes/js/wp-pointer.js': ['./src/js/wp-pointer.js'],
	'src/wp-includes/js/wp-sanitize.js': ['./src/js/wp-sanitize.js'],
	'src/wp-includes/js/wp-util.js': ['./src/js/wp-util.js'],
	'src/wp-includes/js/wpdialog.js': ['./src/js/wpdialog.js'],
	'src/wp-includes/js/wplink.js': ['./src/js/wplink.js'],
	'src/wp-includes/js/zxcvbn-async.js': ['./src/js/zxcvbn-async.js']
}
